...
## 插件地址
[https://packagist.org/packages/spatie/laravel-backup](https://packagist.org/packages/spatie/laravel-backup)

## 安装及配置简介

安装文档 [https://docs.spatie.be/laravel-backup/v3/installation-and-setup](https://docs.spatie.be/laravel-backup/v3/installation-and-setup) 被墙了
